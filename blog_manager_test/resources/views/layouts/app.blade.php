...
<!-- Navbar -->
<header>
    <nav class="bg-blue-500 h-12 fixed top-0 right-0 left-0 flex justify-between items-center">
        <div class="">
            <a class="" href="{{ route('posts.index') }}">Mini-Blog</a>
        </div>
...
<footer class="py-3 bg-black text-white">
    <div class="container d-lg-flex justify-content-between">
        <span class="font-light">Mini-Blog © 2023</span>
    </div>
</footer>
